...
namespace linc.Migrations
{
    ...
    [Migration("20240225133641_Issues")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("linc.Data.ApplicationIssue", b =>
                {
                    ...
                    b.HasIndex("PdfFileId")
                        .HasDatabaseName("ix_issues_pdf_file_id");
            ...
            modelBuilder.Entity("linc.Data.ApplicationIssue", b =>
                {
                    b.HasOne("linc.Data.ApplicationDocument", "PdfFile")
                        .WithMany()
                        .HasForeignKey("PdfFileId")
                        .HasConstraintName("fk_issues_documents_pdf_file_id");
