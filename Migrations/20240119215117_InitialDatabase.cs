    ...
    public partial class InitialDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    last_name = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    display_name_type = table.Column<int>(type: "int", nullable: false),
                    display_email = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    avatar_type = table.Column<int>(type: "int", nullable: false),
                    facebook_avatar_path = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    twitter_avatar_path = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    google_avatar_path = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    internal_avatar_path = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    login_provider = table.Column<string>(type: "varchar(127)", maxLength: 127, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    provider_key = table.Column<string>(type: "varchar(127)", maxLength: 127, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_string_resources", x => x.id);
                    table.ForeignKey(
                        name: "fk_string_resources_languages_language_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_string_resources_key",
                table: "string_resources",
                column: "key");

            migrationBuilder.CreateIndex(
                name: "ix_string_resources_language_id",
                table: "string_resources",
                column: "language_id");
        }
