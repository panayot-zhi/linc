        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    application_dossier_id = table.Column<int>(type: "int", nullable: true),
                    application_source_id = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_authors", x => x.id);
                    table.ForeignKey(
                        name: "fk_authors_dossiers_application_dossier_id",
                        column: x => x.application_dossier_id,
                    ...
                    table.ForeignKey(
                        name: "fk_authors_sources_application_source_id",
                        column: x => x.application_source_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_authors_application_dossier_id",
                table: "authors",
                column: "application_dossier_id");

            migrationBuilder.CreateIndex(
                name: "ix_authors_application_source_id",
                table: "authors",
                column: "application_source_id");
